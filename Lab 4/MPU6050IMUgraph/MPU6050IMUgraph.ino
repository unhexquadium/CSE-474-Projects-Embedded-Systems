...
void loop() {
  ...
  if (delt_t > 200) { // update LCD once per half-second independent of read rate
    ...
    */
    ...
    Serial.print("yaw Total: "); Serial.println(yawTotal);
    Serial.print("yaw Graph: "); Serial.println(yawGraph);
    ...
    if (yawGraph >= 0) {
      tft.drawRect(20, 110 - yawGraph, 20, yawGraph, ILI9341_RED);
      tft.fillRect(20, 110 - yawGraph, 20, yawGraph, ILI9341_RED);
    } else {
      tft.drawRect(20, 110, 20, -yawGraph, ILI9341_RED);
      tft.fillRect(20, 110, 20, -yawGraph, ILI9341_RED);
    }

    if (pitchGraph >= 0) {
      tft.drawRect(60, 110 - pitchGraph, 20, pitchGraph, ILI9341_BLUE);
      tft.fillRect(60, 110 - pitchGraph, 20, pitchGraph, ILI9341_BLUE);
    } else {
      tft.drawRect(60, 110, 20, -pitchGraph, ILI9341_BLUE);
      tft.fillRect(60, 110, 20, -pitchGraph, ILI9341_BLUE);
    }

    if (rollGraph >= 0) {
      tft.drawRect(100, 110 - rollGraph, 20, rollGraph, ILI9341_GREEN);
      tft.fillRect(100, 110 - rollGraph, 20, rollGraph, ILI9341_GREEN);
    } else {
      tft.drawRect(100, 110, 20, -rollGraph, ILI9341_GREEN);
      tft.fillRect(100, 110, 20, -rollGraph, ILI9341_GREEN);
    }
